...
#
# Expectations:
# > human data for hg19, mouse data for mm10
# > single-end 100bp
...
params_aln_threads=5 # put this higher for big bulk-datasets
...
echo "[$params_runid]  Starting HG19-MM10-pipeline..."
...
################################################################################ 
################################################################## map to hybrid
echo "[$params_runid]  - Mapping to hg19-mm10"
mkdir aln
for i in demux_parsed/*.gz; do echo "/hpc/hub_kind/rvanderweide/bin/miniconda3/bin/bowtie2 --quiet --very-sensitive -N 1 -p $params_aln_threads -x /home/hub_kind/rvanderweide/data/hg19_mm10/hg19_mm10 -U $i | samtools view -ubh -F 4  - | samtools sort -l 9 -o aln/$(basename $i | sed 's/fq.gz/hybrid.bam/') - 2> aln/$(basename $i | sed 's/fq.gz/hybrid.err/')"; done > $params_runid.filelists/$params_runid.aln.filelist
...
################################################################################ 
################################################################### split hybrid
echo "[$params_runid]  - Splitting hg19-mm10"
for i in aln/*.hybrid.bam; do echo "sh $SCRIPTPATH/mab-id_split_and_map_hybrid_15062022.sh $i $params_aln_threads" ; done > $params_runid.filelists/$params_runid.split.filelist
N=$(wc -l $params_runid.filelists/$params_runid.split.filelist | cut -f 1 -d " ")
sbatch -Q --wait -J $params_runid.split --time=5:00:00 --mem=20G --array=[1-$N] /hpc/hub_kind/rvanderweide/bin/run_preformatted_cmd_slurm.sh $params_runid.filelists/$params_runid.split.filelist $N

cat aln/*.splitstat > mapped_hybrid_reads.tsv
...
mkdir counts
## TTAA HG19
for i in aln/*TTAA*.hg19.bam; do echo "python /home/hub_kind/rvanderweide/projects/AbID/AbID_pipeline/pipeline_parts/count_ligations_flatten_UMIs.py -vvv --offset -1 --outfile counts/$(basename $i | sed 's/bam/hdf5/') --min-mapq 10 --umi-length 6 --keep-n 1000 --min-editdistance 1 --pos-file /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.posarray.hdf5 $i 2> counts/$(basename $i | sed 's/bam/log/')"; done > $params_runid.filelists/$params_runid.count.filelist
## GATC HG19
for i in aln/*GATC*.hg19.bam; do echo "python /home/hub_kind/rvanderweide/projects/AbID/AbID_pipeline/pipeline_parts/count_ligations_flatten_UMIs.py -vvv --offset 0 --outfile counts/$(basename $i | sed 's/bam/hdf5/') --min-mapq 10 --umi-length 6 --keep-n 1000 --min-editdistance 1 --pos-file /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.posarray.hdf5 $i 2> counts/$(basename $i | sed 's/bam/log/')"; done >> $params_runid.filelists/$params_runid.count.filelist
## TTAA MM10
for i in aln/*TTAA*.mm10.bam; do echo "python /home/hub_kind/rvanderweide/projects/AbID/AbID_pipeline/pipeline_parts/count_ligations_flatten_UMIs.py -vvv --offset -1 --outfile counts/$(basename $i | sed 's/bam/hdf5/') --min-mapq 10 --umi-length 6 --keep-n 1000 --min-editdistance 1 --pos-file /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.posarray.hdf5 $i 2> counts/$(basename $i | sed 's/bam/log/')"; done >> $params_runid.filelists/$params_runid.count.filelist
## GATC MM10
for i in aln/*GATC*.mm10.bam; do echo "python /home/hub_kind/rvanderweide/projects/AbID/AbID_pipeline/pipeline_parts/count_ligations_flatten_UMIs.py -vvv --offset 0 --outfile counts/$(basename $i | sed 's/bam/hdf5/') --min-mapq 10 --umi-length 6 --keep-n 1000 --min-editdistance 1 --pos-file /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.posarray.hdf5 $i 2> counts/$(basename $i | sed 's/bam/log/')"; done >> $params_runid.filelists/$params_runid.count.filelist
...
## TTAA HG19
for i in counts/*TTAA*.hg19.hdf5; do echo "bin_countfile.py --binsize 1000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.1k.hdf5/') $i"; done > $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*TTAA*.hg19.hdf5; do echo "bin_countfile.py --binsize 5000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.5k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*TTAA*.hg19.hdf5; do echo "bin_countfile.py --binsize 20000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.20k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist

## GATC HG19
for i in counts/*GATC*.hg19.hdf5; do echo "bin_countfile.py --binsize 1000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.1k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*GATC*.hg19.hdf5; do echo "bin_countfile.py --binsize 5000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.5k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*GATC*.hg19.hdf5; do echo "bin_countfile.py --binsize 20000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/hg19/hg19_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.20k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist

## TTAA MM10
for i in counts/*TTAA*.mm10.hdf5; do echo "bin_countfile.py --binsize 1000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.1k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*TTAA*.mm10.hdf5; do echo "bin_countfile.py --binsize 5000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.5k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*TTAA*.mm10.hdf5; do echo "bin_countfile.py --binsize 20000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.TTAA.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.20k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist

## GATC MM10
for i in counts/*GATC*.mm10.hdf5; do echo "bin_countfile.py --binsize 1000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.1k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*GATC*.mm10.hdf5; do echo "bin_countfile.py --binsize 5000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.5k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
for i in counts/*GATC*.mm10.hdf5; do echo "bin_countfile.py --binsize 20000 --posfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.posarray.hdf5 --mapfile /home/hub_kind/rvanderweide/data/MAb-ID/mm10/mm10_mabid.GATC.readlength_70.min_mapq_10.bowtie2.maparray.hdf5 --outfile counts/$(basename $i | sed 's/.hdf5/.20k.hdf5/') $i"; done >> $params_runid.filelists/$params_runid.bin.filelist
